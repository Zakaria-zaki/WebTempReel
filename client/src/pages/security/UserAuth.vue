        ...
        <div class="grid">
            <form @submit.prevent="submitForm" class="form login">
                <div class="form__field">
                    ...
                    <input id="login__username" type="text" name="username" class="form__input" placeholder="Username" required v-model.trim="email">
                </div>
                <div class="form__field">
                    <label for="login__password"><svg class="icon">
                        <use xlink:href="#icon-lock"></use>
                    </svg><span class="hidden">Password</span></label>
                    <input id="login__password" type="password" name="password" class="form__input" placeholder="Password" required v-model.trim="password">
                </div>
